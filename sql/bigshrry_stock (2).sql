...
--
-- Host: localhost:3306
-- Generation Time: Jun 27, 2023 at 07:05 AM
...
CREATE TABLE `customer_gender` (
  `gen_id` int(11) NOT NULL COMMENT 'รหัส',
  `gen_gender` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'เพศ',
  `gen_note` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'หมายเหตุ'
...
INSERT INTO `customer_gender` (`gen_id`, `gen_gender`, `gen_note`) VALUES
(1, 'ชาย', '-'),
(2, 'หญิง', '-');
...
CREATE TABLE `customer_group` (
  `cg_id` int(11) NOT NULL COMMENT 'รหัส',
  `cg_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'ชื่อกลุ่ม',
  `cg_note` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'หมายเหตุ'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
INSERT INTO `customer_group` (`cg_id`, `cg_name`, `cg_note`) VALUES
(1, 'ahjgg', 'gfghfghfg'),
(2, 's', '-');
...
CREATE TABLE `customer_level` (
  `lv_id` int(11) NOT NULL COMMENT 'รหัส',
  `lv_level` varchar(100) NOT NULL COMMENT 'ระดับลูกค้า',
  `lv_note` varchar(200) NOT NULL COMMENT 'หมายเหตุ'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
INSERT INTO `customer_level` (`lv_id`, `lv_level`, `lv_note`) VALUES
(2, 'test', 'test'),
(3, 'test', 'test234'),
(4, 'd', 'aasdf');
...
CREATE TABLE `tb_borrow` (
  `bor_id` int(11) NOT NULL COMMENT 'รหัส',
  `pl_name_product` varchar(100) NOT NULL COMMENT 'ชื่อสินค้า',
  `pl_product_id` varchar(100) NOT NULL COMMENT 'รหัสสินค้า',
  `pl_storage` varchar(100) NOT NULL COMMENT 'ที่จัดเก็บ',
  `bor_quantity` int(11) NOT NULL COMMENT 'จำนวนยืม',
  `bor_date` varchar(20) NOT NULL COMMENT 'วันที่ยืม',
  `bor_qtyreturn` int(10) NOT NULL COMMENT 'จำนวนคืน',
  `bor_datereturn` varchar(100) NOT NULL COMMENT 'วันที่คืน'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
INSERT INTO `tb_borrow` (`bor_id`, `pl_name_product`, `pl_product_id`, `pl_storage`, `bor_quantity`, `bor_date`, `bor_qtyreturn`, `bor_datereturn`) VALUES
(45, 'Apple Watch', 'A203', '', 9, '2023-03-11', 0, ''),
(46, 'Apple Watch', 'A203', '', 20, '2023-03-11', 0, ''),
(47, 'noname', 'A299', 'storage', 15, '2023-03-11', 0, ''),
(48, 'iPhone 14', 'A201', '', 5, '2023-03-11', 0, ''),
(49, 'Macbook Pro', 'A202', '', 1, '2023-03-11', 0, '');
...
CREATE TABLE `tb_categorie` (
  `cat_id` int(10) NOT NULL COMMENT 'รหัสหมวดหมู่',
  `cat_name_categorie` varchar(100) NOT NULL COMMENT 'ชื่อหมวดหมู่'
...
INSERT INTO `tb_categorie` (`cat_id`, `cat_name_categorie`) VALUES
(1, 'สุกร : SWINE'),
(2, 'โค : BOVINE'),
(3, 'ม้า : EQUINE'),
(4, 'แพะแกะ : CAPRINE'),
(5, 'สุนัข : CANINE'),
(6, 'ไก่ : POULTRY'),
(7, 'อุปกรณ์ห้อง LAB : Lab Equipment & Supplies'),
(8, 'เครื่องแก้ว และภาชนะพลาสติก : Glassware & Plasticware'),
(9, 'เครื่องมือสัตวแพทย์ : Medical Device'),
(10, 'อุปกรณ์ฟาร์ม : Farm Equipment'),
(11, 'อุปกรณ์ทำเครื่องหมายสัตว์ : Animal Identification Equipment'),
(12, 'ยา วิตามิน และอาหารเสริมสัตว์ : Drugs, Vitamins & Supplements for Animal');
...
CREATE TABLE `tb_contact` (
  `con_id` int(10) NOT NULL COMMENT 'รหัส',
  `cus_id` int(10) NOT NULL COMMENT 'รหัสลูกค้า',
  `con_detail` varchar(200) NOT NULL COMMENT 'รายละเอียด',
  `con_social` varchar(200) NOT NULL COMMENT 'ช่องทางการติดต่อ',
  `con_score` varchar(100) NOT NULL COMMENT 'คะแนน',
  `od_id` int(10) NOT NULL COMMENT 'รหัสออเดอร์',
  `con_note` varchar(200) NOT NULL COMMENT 'หมายเหตุ',
  `con_date` varchar(20) NOT NULL COMMENT 'วันที่'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

-- --------------------------------------------------------

--
-- Table structure for table `tb_counting_unit`
--

CREATE TABLE `tb_counting_unit` (
  `ctu_id` int(11) NOT NULL COMMENT 'รหัส',
  `ctu_name` varchar(100) NOT NULL COMMENT 'ชื่อ'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `tb_counting_unit`
--

INSERT INTO `tb_counting_unit` (`ctu_id`, `ctu_name`) VALUES
(8, 'ด้าม'),
(9, 'ชิ้น'),
(11, 'เครื่อง');
...
CREATE TABLE `tb_customer` (
  ...
  `cus_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'ชื่อลูกค้า',
  `cus_lastname` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'นามสกุล',
  `cus_address` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'ที่อยู่',
  `cus_province` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'จังหวัด',
  `cus_amphoe` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'อำเภอ',
  `cus_tambon` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'ตำบล',
  `cus_phone` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'เบอร์โทร',
  `cus_date` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'วัน เดือน ปี เกิด',
  `cus_email` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'อีเมลล์',
  `cus_gender` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'เพศ',
  `cus_group` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'กลุ่ม',
  `cus_level` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'ระดับ',
  `cus_note` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'หมายเหตุ',
  `cus_member_card` varchar(20) NOT NULL COMMENT 'บัตรสมาชิก'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
...
INSERT INTO `tb_customer` (`cus_id`, `code_customer`, `cus_name`, `cus_lastname`, `cus_address`, `cus_province`, `cus_amphoe`, `cus_tambon`, `cus_phone`, `cus_date`, `cus_email`, `cus_gender`, `cus_group`, `cus_level`, `cus_note`, `cus_member_card`) VALUES
(15, '', '123', '1231', '123', '1', '1', '100101', '123', '2023-03-12', '123@gmail.com', '1', '1', '2', '231', '476646'),
(16, '', '1234', '1234', '1234', '1', '2', '100202', '1234', '2023-03-12', 'asdf@gmail.com', '1', '1', '2', '1234', '571569'),
(17, '', '3456', '3456', '3456', '4', '66', '130102', '3456', '2023-03-12', 'asdf@gmail.com', '2', '1', '3', '3456', '168324'),
(18, '', '456', '456', '456', '8', '111', '170302', '456', '2023-03-12', '123@gmail.com', '2', '1', '2', '456', '590835'),
(19, '', '3459678', '6789', '6789', '9', '117', '180303', '6789', '2023-03-12', 'asdf@gmail.com', '2', '1', '2', '6789', '783474'),
(20, '', 'ฟหกด', 'ฟหกด', 'ฟหกด', '6', '93', '150405', '-ภ--ภ', '2023-03-12', 'asdf@gmail.com', '1', '2', '4', 'ฟหกด', '803623');
...
CREATE TABLE `tb_order_product` (
  ...
  `sum_total_discount` int(11) NOT NULL,
...
INSERT INTO `tb_order_product` (`order_id`, `sp_id`, `product_id`, `qty`, `total_price`, `discount`, `sum_total_discount`, `cost`) VALUES
(1, 1, 1, 1, 20000, 0, 20000, 10000),
(2, 2, 1, 7, 140000, 0, 140000, 70000),
(3, 3, 2, 1, 89, 0, 89, 80),
(4, 4, 2, 1, 89, 0, 89, 80),
(5, 5, 2, 1, 89, 0, 89, 80),
(6, 6, 2, 1, 89, 0, 89, 80),
...
(8, 8, 2, 1, 89, 0, 89, 80),
(9, 9, 2, 1, 89, 0, 89, 80),
(10, 10, 2, 1, 89, 0, 89, 80),
(11, 11, 2, 1, 89, 0, 89, 80),
(12, 12, 2, 1, 89, 0, 89, 80),
(13, 13, 2, 1, 89, 0, 89, 80),
(14, 14, 2, 1, 89, 0, 89, 80),
(15, 15, 2, 1, 89, 0, 89, 80),
(16, 16, 2, 1, 89, 0, 89, 80),
(17, 17, 2, 1, 89, 0, 89, 80),
(18, 18, 2, 1, 89, 0, 89, 80),
(19, 19, 2, 1, 89, 0, 89, 80),
(20, 20, 2, 1, 89, 0, 89, 80),
(21, 21, 2, 1, 89, 0, 89, 80),
(22, 22, 2, 1, 89, 0, 89, 80),
(23, 23, 2, 1, 89, 0, 89, 80),
(24, 24, 2, 1, 89, 0, 89, 80),
(25, 25, 2, 1, 89, 0, 89, 80),
(26, 26, 2, 1, 89, 0, 89, 80),
(27, 27, 2, 1, 89, 0, 89, 80),
(28, 28, 2, 1, 89, 0, 89, 80),
(29, 29, 2, 1, 89, 0, 89, 80),
(30, 30, 2, 1, 89, 0, 89, 80),
(31, 31, 2, 1, 89, 0, 89, 80),
(32, 32, 2, 1, 89, 0, 89, 80),
(33, 33, 2, 1, 89, 0, 89, 80),
(34, 34, 2, 1, 89, 0, 89, 80),
(35, 35, 2, 1, 89, 0, 89, 80),
(36, 36, 2, 1, 89, 0, 89, 80),
(37, 37, 2, 1, 89, 0, 89, 80),
(38, 38, 2, 1, 89, 0, 89, 80),
(39, 39, 2, 1, 89, 0, 89, 80),
(40, 40, 2, 1, 89, 0, 89, 80),
(41, 41, 2, 1, 89, 0, 89, 80),
(42, 42, 2, 1, 89, 0, 89, 80),
(43, 43, 2, 1, 89, 0, 89, 80),
(44, 44, 2, 1, 89, 0, 89, 80),
(45, 45, 1, 1, 20000, 0, 20000, 10000),
(46, 45, 1, 1, 20000, 0, 20000, 10000),
(47, 45, 1, 1, 20000, 0, 20000, 10000),
(48, 46, 1, 1, 20000, 0, 20000, 10000),
(49, 47, 1, 1, 20000, 0, 20000, 10000),
(50, 48, 1, 1, 20000, 0, 20000, 10000),
(51, 49, 1, 1, 20000, 0, 20000, 10000),
(52, 50, 1, 1, 20000, 0, 20000, 10000),
(53, 51, 1, 1, 20000, 0, 20000, 10000),
(54, 52, 2, 1, 89, 0, 89, 80),
(55, 53, 2, 1, 89, 0, 89, 80),
(56, 54, 2, 1, 89, 0, 89, 80),
(57, 55, 2, 1, 89, 0, 89, 80),
(58, 56, 2, 1, 89, 0, 89, 80),
(59, 57, 2, 1, 89, 0, 89, 80),
(60, 58, 2, 1, 89, 0, 89, 80),
(61, 59, 2, 1, 89, 0, 89, 80),
(62, 60, 2, 1, 89, 0, 89, 80),
(63, 61, 2, 1, 89, 0, 89, 80),
(64, 62, 2, 1, 89, 0, 89, 80),
(65, 63, 2, 1, 89, 0, 89, 80),
(66, 64, 2, 1, 89, 0, 89, 80),
(67, 65, 1, 1, 20000, 0, 20000, 10000),
(68, 66, 1, 1, 20000, 0, 20000, 10000),
(69, 67, 3, 1, 0, 0, 0, 33),
(70, 67, 2, 1, 0, 0, 0, 234);
...
--
-- Table structure for table `tb_productlist`
--

CREATE TABLE `tb_productlist` (
  `id` int(11) NOT NULL,
  `pl_product_id` varchar(100) NOT NULL COMMENT 'รหัสสินค้า	',
  `pl_img` varchar(200) DEFAULT NULL COMMENT 'รูปภาพ',
  `pl_name_product` varchar(100) NOT NULL COMMENT 'ชื่อสินค้า',
  `c_id` int(10) DEFAULT NULL COMMENT 'รหัสหมวดหมู่',
  `pl_counting_unit` varchar(100) DEFAULT NULL COMMENT 'หน่วยนับ',
  `pl_price1` float DEFAULT NULL COMMENT 'ราคา1',
  `pl_price2` varchar(10) DEFAULT NULL COMMENT 'ราคา2',
  `pl_price3` varchar(10) DEFAULT NULL COMMENT 'ราคา3',
  `s_id` int(10) DEFAULT NULL COMMENT 'รหัสซัพพาย',
  `pl_cost` int(10) NOT NULL COMMENT 'ต้นทุน',
  `pl_storage` varchar(100) DEFAULT NULL COMMENT 'ที่จัดเก็บ',
  `pl_discount` varchar(10) NOT NULL DEFAULT '0' COMMENT 'ส่วนลด',
  `pl_quantity` int(10) NOT NULL COMMENT 'จำนวนคงเหลือ',
  `pl_revenue` varchar(10) DEFAULT NULL COMMENT 'รายรับประมาณการ/บาท',
  `pl_exp` varchar(20) NOT NULL COMMENT 'วันหมดอายุ',
  `pl_lot_no` varchar(100) NOT NULL,
  `sub_id` int(20) NOT NULL COMMENT 'idหมวดหมู่ย่อย'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

--
-- Dumping data for table `tb_productlist`
--

INSERT INTO `tb_productlist` (`id`, `pl_product_id`, `pl_img`, `pl_name_product`, `c_id`, `pl_counting_unit`, `pl_price1`, `pl_price2`, `pl_price3`, `s_id`, `pl_cost`, `pl_storage`, `pl_discount`, `pl_quantity`, `pl_revenue`, `pl_exp`, `pl_lot_no`, `sub_id`) VALUES
(2, '342', '35920868Screenshot 2023-03-07 212533.png', '234', 2, '8', 234, '234', '234', 1, 234, '234', '0', 1232, NULL, '2023-03-12', '234', 10),
(3, '33', '89688414Screenshot 2023-03-03 212043.png', '33', 1, '8', 33, '33', '33', 1, 33, '33', '0', 3, NULL, '2023-03-12', '33', 5),
(4, '11', '45642037Screenshot 2023-03-04 122459.png', '11', 2, '9', 11, '11', '11', 1, 11, '11', '0', 3, NULL, '2023-03-12', '11', 11),
(5, '555', '62305144Screenshot 2023-03-09 180922.png', '55', 1, '8', 55, '55', '55', 1, 55, '55', '0', 5, NULL, '2023-03-12', '55', 9);
...
CREATE TABLE `tb_sale_product` (
  `sp_id` int(10) NOT NULL COMMENT 'รหัส',
  `customer_id` int(11) NOT NULL,
  `order_code` varchar(100) NOT NULL COMMENT 'รหัสการขาย',
  `sp_qty_sale` varchar(10) NOT NULL COMMENT 'จำนวนที่ขาย',
  `sp_sell` varchar(10) NOT NULL COMMENT 'ขาย',
  `price_discount` int(11) NOT NULL,
  `vat` float NOT NULL COMMENT 'ภาษี',
  `total_sum_vat` float NOT NULL COMMENT 'ราคารวมภาษี',
  `get_money` int(100) NOT NULL COMMENT 'รับเงิน',
  `change_money` float NOT NULL COMMENT 'ทอนเงิน',
  `sell_date` varchar(100) NOT NULL COMMENT 'วันที่ขาย'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `tb_sale_product` (`sp_id`, `customer_id`, `order_code`, `sp_qty_sale`, `sp_sell`, `price_discount`, `vat`, `total_sum_vat`, `get_money`, `change_money`, `sell_date`) VALUES
(1, 0, '0', '1', '20000', 0, 1400, 21400, 22000, 600, '11/03/2023 08:11'),
(2, 9, '1', '7', '20000', 0, 0, 140000, 140000, 0, '11/03/2023 19:24'),
(3, 0, '2', '1', '89', 0, 0, 89, 100, 11, '11/03/2023 21:30'),
(4, 0, '3', '1', '89', 0, 0, 89, 100, 11, '11/03/2023 21:34'),
(5, 0, '4', '1', '89', 0, 0, 89, 100, 11, '11/03/2023 21:35'),
(6, 0, '5', '1', '89', 0, 0, 89, 100, 11, '11/03/2023 21:38'),
(7, 0, '6', '1', '89', 0, 0, 89, 100, 11, '11/03/2023 21:51'),
(8, 0, '7', '1', '89', 0, 0, 89, 100, 11, '11/03/2023 21:51'),
(9, 0, '8', '1', '89', 0, 0, 89, 100, 11, '11/03/2023 21:52'),
(10, 0, '9', '1', '89', 0, 0, 89, 100, 11, '11/03/2023 21:53'),
(11, 0, '10', '1', '89', 0, 0, 89, 100, 11, '11/03/2023 21:55'),
(12, 0, '11', '1', '89', 0, 0, 89, 100, 11, '11/03/2023 21:56'),
(13, 0, '12', '1', '89', 0, 0, 89, 100, 11, '11/03/2023 21:58'),
(14, 0, '13', '1', '89', 0, 0, 89, 100, 11, '11/03/2023 21:59'),
(15, 0, '14', '1', '89', 0, 0, 89, 100, 11, '11/03/2023 21:59'),
(16, 0, '15', '1', '89', 0, 0, 89, 100, 11, '11/03/2023 22:00'),
(17, 2, '16', '1', '89', 0, 0, 89, 100, 11, '11/03/2023 22:10'),
(18, 0, '17', '1', '89', 0, 0, 89, 100, 11, '11/03/2023 22:15'),
(19, 0, '18', '1', '89', 0, 0, 89, 100, 11, '11/03/2023 22:19'),
(20, 9, '19', '1', '89', 0, 0, 89, 100, 11, '11/03/2023 22:19'),
(21, 2, '20', '1', '89', 0, 0, 89, 100, 11, '11/03/2023 22:26'),
(22, 0, '21', '1', '89', 0, 0, 89, 100, 11, '11/03/2023 22:26'),
(23, 2, '22', '1', '89', 0, 0, 89, 100, 11, '11/03/2023 22:27'),
(24, 2, '23', '1', '89', 0, 0, 89, 100, 11, '11/03/2023 22:35'),
(25, 10, '24', '1', '89', 0, 0, 89, 100, 11, '11/03/2023 22:45'),
(26, 0, '25', '1', '89', 0, 0, 89, 100, 11, '11/03/2023 22:46'),
(27, 0, '26', '1', '89', 0, 0, 89, 100, 11, '11/03/2023 22:46'),
(28, 0, '27', '1', '89', 0, 0, 89, 100, 11, '11/03/2023 23:03'),
(29, 2, '28', '1', '89', 0, 0, 89, 100, 11, '11/03/2023 23:03'),
(30, 8, '29', '1', '89', 0, 0, 89, 100, 11, '11/03/2023 23:05'),
(31, 8, '30', '1', '89', 0, 0, 89, 200, 111, '11/03/2023 23:07'),
(32, 8, '31', '1', '89', 0, 0, 89, 100, 11, '11/03/2023 23:08'),
(33, 8, '32', '1', '89', 0, 0, 89, 100, 11, '11/03/2023 23:09'),
(34, 8, '33', '1', '89', 0, 0, 89, 200, 111, '11/03/2023 23:09'),
(35, 8, '34', '1', '89', 0, 0, 89, 100, 11, '11/03/2023 23:10'),
(36, 2, '35', '1', '89', 0, 0, 89, 100, 11, '11/03/2023 23:13'),
(37, 2, '36', '1', '89', 0, 0, 89, 100, 11, '11/03/2023 23:15'),
(38, 2, '37', '1', '89', 0, 0, 89, 100, 11, '11/03/2023 23:18'),
(39, 2, '38', '1', '89', 0, 0, 89, 100, 11, '11/03/2023 23:20'),
(40, 2, '39', '1', '89', 0, 0, 89, 100, 11, '11/03/2023 23:20'),
(41, 9, '40', '1', '89', 0, 0, 89, 100, 11, '11/03/2023 23:21'),
(42, 11, '41', '1', '89', 0, 0, 89, 200, 111, '11/03/2023 23:24'),
(43, 13, '42', '1', '89', 0, 0, 89, 100, 11, '11/03/2023 23:31'),
(44, 9, '43', '1', '89', 0, 0, 89, 100, 11, '11/03/2023 23:32'),
(45, 0, '44', '3', '60000', 0, 4200, 64200, 80000, 15800, '12/03/2023 10:02'),
(46, 0, '45', '1', '20000', 0, 1400, 21400, 20000, -1400, '12/03/2023 12:41'),
(47, 0, '46', '1', '20000', 0, 1400, 21400, 21000, -400, '12/03/2023 12:43'),
(48, 0, '47', '1', '20000', 0, 0, 20000, 21000, 1000, '12/03/2023 12:43'),
(49, 0, '48', '1', '20000', 0, 0, 20000, 21000, 1000, '12/03/2023 12:44'),
(50, 0, '49', '1', '20000', 0, 0, 20000, 22000, 2000, '12/03/2023 12:49'),
(51, 0, '50', '1', '20000', 0, 1400, 21400, 22000, 600, '12/03/2023 12:49'),
(52, 0, '51', '1', '89', 0, 0, 89, 100, 11, '12/03/2023 12:52'),
(53, 0, '52', '1', '89', 0, 6.23, 95.23, 100, 4.77, '12/03/2023 12:52'),
(54, 0, '53', '1', '89', 0, 6.23, 95.23, 100, 4.77, '12/03/2023 12:53'),
(55, 0, '54', '1', '89', 0, 6.23, 95.23, 100, 4.77, '12/03/2023 12:54'),
(56, 0, '55', '1', '89', 0, 0, 89, 100, 11, '12/03/2023 12:55'),
(57, 0, '56', '1', '89', 0, 0, 89, 100, 11, '12/03/2023 12:56'),
(58, 0, '57', '1', '89', 0, 6.23, 95.23, 100, 4.77, '12/03/2023 12:56'),
(59, 0, '58', '1', '89', 0, 0, 89, 100, 11, '12/03/2023 12:58'),
(60, 0, '59', '1', '89', 0, 0, 89, 100, 11, '12/03/2023 13:02'),
(61, 0, '60', '1', '89', 0, 0, 89, 100, 11, '12/03/2023 13:05'),
(62, 0, '61', '1', '89', 0, 0, 89, 100, 11, '12/03/2023 13:05'),
(63, 0, '62', '1', '89', 0, 0, 89, 100, 11, '12/03/2023 13:09'),
(64, 0, '63', '1', '89', 0, 0, 89, 100, 11, '12/03/2023 13:10'),
(65, 0, '64', '1', '20000', 0, 0, 20000, 21000, 1000, '12/03/2023 13:12'),
(66, 0, '65', '1', '20000', 0, 0, 20000, 21000, 1000, '12/03/2023 14:16'),
(67, 0, '66', '2', '0', 0, 0, 0, 23432, 23432, '16/03/2023 13:33');
...
INSERT INTO `tb_sub_category` (`sub_id`, `sub_name`, `category_id`) VALUES
(5, 'สารเลี้ยงน้ำเชื้อสุกร', 1),
(6, 'สารคัดแยกเพศน้ำเชื้อสุกร', 1),
(7, 'น้ำสำหรับห้องปฏิบัติการ', 1),
(8, 'อุปกรณ์รีดน้ำเชื้อสุกร', 1),
(9, 'อุปกรณ์ผสมเทียมสุกร', 1),
(10, 'สารเลี้ยงน้ำเชื้อโค', 2),
(11, 'สารคัดแยกเพศน้ำเชื้อโค', 2),
(12, 'อุปกรณ์รีดน้ำเชื้อโค', 2),
(13, 'อุปกรณ์ผสมเทียมโค', 2),
(14, 'อุปกรณ์ในการย้ายฝากตัวอ่อน', 2),
(15, 'อุปกรณ์ในการแช่แข็งตัวอ่อน : Embry', 2),
(16, 'ถังไนโตรเจนเหลวเก็บน้ำเชื้อแช่แข็ง และไนโตรเจนเหลว', 2),
(17, 'อุปกรณ์ประกวดโค', 2),
(18, 'กล้องจุลทรรศน์', 7),
(19, 'เครื่องอุ่นแผ่นสไลด์', 7),
(20, 'ไมโครไปเปต และไปเปต ทิป', 7),
(21, 'แผ่นสไลด์ และกระจกปิดสไลด์', 7),
(22, 'เครื่องมือวัดค่าต่าง ๆ', 7),
(23, 'อ่างน้ำควบคุมอุณหภูมิ', 7),
(24, 'เครื่องกวนสาร', 7),
(25, 'เครื่องวัดความเข้มข้นน้ำเชื้อ', 7),
(26, 'โปรแกรมวิเคราะห์คุณภาพน้ำเชื้อสุกร', 7),
(27, 'เครื่องเตรียมสารละลาย และเครื่องบรรจุน้ำเชื้อสุกร', 7),
(28, 'วัสดุอุปกรณ์สำหรับบรรจุน้ำเชื้อสุกร', 7),
(29, 'ตู้เก็บรักษาน้ำเชื้อสุกร และวัคซีน', 7),
(30, 'กล่องขนส่งน้ำเชื้อ', 7),
(31, 'ตู้อบฆ่าเชื้อ', 7),
(32, 'อุปกรณ์สแตนเลส อลูมิเนียม', 7),
(33, 'เครื่องแก้ว', 8),
(34, 'ภาชนะพลาสติก', 8),
(35, 'ไซริงค์ฉีดยา พลาสติก, แบบใช้ครั้งเดียวทิ้ง', 9),
(36, 'ไซริงค์ฉีดยา, แบบต้มได้', 9),
(37, 'ไซริงค์ฉีดยาอัตโนมัติ ', 9),
(38, 'ไซริงค์กรอกยา', 9),
(39, 'เข็มฉีดยา', 9),
(40, 'กรรไกรผ่าตัด คีมจับเส้นโลหิต คีมจับเข็มเย็บแผล และคีมจับเนื้อเยื่อ', 9),
(41, 'ใบมีดผ่าตัด และด้ามมีดผ่าตัด', 9),
(42, 'เข็บเย็บแบบโค้ง และไหมละลาย', 9),
(43, 'ถุงมือแพทย์', 9),
(44, 'ฟาร์ม สุกร', 10),
(45, 'ฟาร์ม โค', 10),
(46, 'ฟาร์ม แพะ', 10),
(47, 'สายวัดน้ำหนักสัตว์', 10),
(48, 'โคมไฟกกสัตว์ หลอดไฟไล่ยุง', 10),
(49, 'เครื่องอัลตร้าซาวด์ สำหรับตรวจการตั้งท้องของสัตว์ และตรวจระบบสืบพันธุ์สัตว์', 10),
(50, 'เครื่องปัตตาเลี่ยนตัดขนสัตว์', 10),
(51, 'อุปกรณ์ สำหรับใช้ในโรงนา', 10),
(52, 'อุปกรณ์ บังคับสัตว์', 10),
(53, 'เสื้อผ้า รองเท้า ป้องกันเชื้อและสิ่งสกปรก', 10),
(54, 'อุปกรณ์รักษากีบเท้าสัตว์ และผลิตภัณฑ์ทำความสะอาด', 10),
(55, 'ที่ตักอาหารสำหรับสัตว์', 10),
(56, 'เจลหล่อลื่น', 10),
(57, 'เบอร์หูสัตว์', 11),
(58, 'คีมเจาะ และคีมตัดหูสุกร', 11),
(59, 'ชุดสักเบอร์หู และชุดตัวเลข ชุดตัวอักษร', 11),
(60, 'หมึกสักเบอร์หูสัตว์', 11),
(61, 'แท่งสีเขียนสัตว์', 11),
(62, 'สายรัดข้อเท้าสัตว์ และตัวเลข', 11),
(63, 'ฮอร์โมน', 12),
(64, 'ยาถ่ายพยาธิ ยากำจัดปรสิต', 12),
(65, 'วิตามิน', 12),
(66, 'ยาปฏิชีวนะ', 12),
(67, 'วัคซีน', 12),
(68, 'อาหารเสริม', 12),
(69, 'แร่ธาตุก้อน', 12),
(70, 'น้ำเกลือ และน้ำกลั่นสำหรับฉีดสัตว์', 12),
(71, 'วัสดุ และอุปกรณ์ทำแผลสัตว์', 12);
...
CREATE TABLE `tb_supplier` (
  `sup_id` int(11) NOT NULL COMMENT 'รหัส',
  `sup_member_id` int(10) NOT NULL COMMENT 'รหัสสมาชิก',
  `sup_name` varchar(100) NOT NULL COMMENT 'ชื่อ',
  `sup_vat_number` varchar(100) NOT NULL COMMENT 'เลขบัตร/เลขเสียภาสี',
  `sup_img` varchar(200) NOT NULL COMMENT 'รูป',
  `sup_address` varchar(100) NOT NULL COMMENT 'ที่อยู่',
  `sup_phone` varchar(10) NOT NULL COMMENT 'เบอร์โทร',
  `sup_birthday` varchar(10) NOT NULL COMMENT 'วันเกิด'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `tb_supplier` (`sup_id`, `sup_member_id`, `sup_name`, `sup_vat_number`, `sup_img`, `sup_address`, `sup_phone`, `sup_birthday`) VALUES
(1, 0, 'PCinter', '', '56132553Screenshot 2023-03-06 210906.png', '', '', '');
...
INSERT INTO `tb_user` (`user_id`, `username`, `password`, `type`) VALUES
(1, 'admin', 'admin', 999);
...
--
-- Indexes for table `tb_categorie`
--
...
--
-- Indexes for table `tb_counting_unit`
--
ALTER TABLE `tb_counting_unit`
...
--
-- Indexes for table `tb_productlist`
--
ALTER TABLE `tb_productlist`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `customer_gender`
  MODIFY `gen_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัส', AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `customer_group`
--
ALTER TABLE `customer_group`
  MODIFY `cg_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัส', AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `customer_level`
--
ALTER TABLE `customer_level`
  MODIFY `lv_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัส', AUTO_INCREMENT=6;
...
--
ALTER TABLE `tb_borrow`
  MODIFY `bor_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัส', AUTO_INCREMENT=50;

--
-- AUTO_INCREMENT for table `tb_categorie`
--
ALTER TABLE `tb_categorie`
  MODIFY `cat_id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'รหัสหมวดหมู่', AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `tb_contact`
--
ALTER TABLE `tb_contact`
  MODIFY `con_id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'รหัส';

--
-- AUTO_INCREMENT for table `tb_counting_unit`
--
ALTER TABLE `tb_counting_unit`
  MODIFY `ctu_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัส', AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `tb_customer`
--
ALTER TABLE `tb_customer`
  MODIFY `cus_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัส', AUTO_INCREMENT=21;
...
--
-- AUTO_INCREMENT for table `tb_productlist`
--
ALTER TABLE `tb_productlist`
...
--
ALTER TABLE `tb_sale_product`
  MODIFY `sp_id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'รหัส', AUTO_INCREMENT=68;

--
-- AUTO_INCREMENT for table `tb_sub_category`
--
ALTER TABLE `tb_sub_category`
  MODIFY `sub_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;

--
-- AUTO_INCREMENT for table `tb_supplier`
--
ALTER TABLE `tb_supplier`
  MODIFY `sup_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัส', AUTO_INCREMENT=12;
